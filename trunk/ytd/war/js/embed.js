...
function init() {
	...
	if (navigator.geolocation) {
	  jQuery.each(jQuery('input[name="location"]'), function(index, locationField) {
	    ...
	    jQuery('<img src="/images/geolocation_icon.png" title="Auto-detect your current location." style="margin-left: 5px; cursor: pointer;">').insertAfter(locationField).click(function(event) {
