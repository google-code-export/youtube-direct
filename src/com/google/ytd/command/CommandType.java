...
public enum CommandType {
  GET_VIDEO_SUBMISSIONS(GetVideoSubmissions.class), UPDATE_VIDEO_SUBMISSION_STATUS(
      UpdateVideoSubmissionStatus.class), UPDATE_VIDEO_SUBMISSION_ADMIN_NOTES(
      UpdateVideoSubmissionAdminNotes.class), NEW_ASSIGNMENT(NewAssignment.class), GET_ASSIGNMENTS(
