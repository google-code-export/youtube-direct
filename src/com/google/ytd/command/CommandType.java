...
public enum CommandType {
  NEW_SUBMISSION(NewSubmission.class), 
  GET_SUBMISSIONS(GetSubmissions.class),
  UPDATE_SUBMISSION_STATUS(UpdateSubmissionStatus.class), 
  UPDATE_SUBMISSION_ADMIN_NOTES(UpdateSubmissionAdminNotes.class), 
