...
public class UpdateAdminConfigCommand extends Command {
  ...
  public JSONObject execute() throws JSONException {
    ...
    if (!util.isNullOrEmpty(moderationMode)) {
      adminConfig.setModerationMode(ModerationModeType.valueOf(
          moderationMode.toUpperCase()).ordinal());
    }
    ...
    if (!util.isNullOrEmpty(submissionMode)) {
      adminConfig.setSubmissionMode(SubmissionModeType.valueOf(
          submissionMode.toUpperCase()).ordinal());
    }
