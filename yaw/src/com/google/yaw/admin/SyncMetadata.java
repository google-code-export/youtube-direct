 ...
 * This servlet is meant to be pinged periodically via App Engine's cron functionality.
 * Invoking it once every few minutes should be enough, though it may need to be tweaked if there
 * are a large number of VideoSubmission entries. Don't invoke this more than once every 30 seconds
 * because this may take up to 30 seconds to complete.
 */
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    ...
    try {
      ...
      for (VideoSubmission videoSubmission : videoSubmissions) {
        ...
        // It's important to update lastSynced even for videos that didn't change; otherwise, if
        // syncing takes longer than the timeout, the same unchanged videos might be examined again
      ...
      // App Engine imposes a 30 second timeout on requests (the development server doesn't).
      // We should be able to handle this gracefully by logging it and closing the PM connection.
